...
async function main() {
  const providers = [
    ...
    { source: 'ubs', display_name: 'UBS', type: 'fisik', logo: '/logos/ubs.png', url_homepage: 'https://ubslifestyle.com/fine-gold/logam-mulia-ubs' },
    { source: 'galeri24', display_name: 'Galeri24', type: 'fisik', logo: '/logos/galery24.png', url_homepage: 'https://galeri24.co.id' },
    { source: 'lotus-archi', display_name: 'Lotus Archi', type: 'fisik', logo: '/logos/lotus-archi.png', url_homepage: 'https://lotusarchi.com' },
    { source: 'emasku', display_name: 'Emasku', type: 'fisik', logo: '/logos/emasku.png', url_homepage: 'https://www.emasku.co.id/id' },
